...
const getInput = () => {
    return {
        ...
        dueDate: ()=>{ 
            const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(document.getElementById('inputDate').value), 'dd MM yy');
...
function actionNewToDoList(e){
    ...
    //add the variable of to do list to the aray 
     if (verifyInput(task) === true)  { 
        ...
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)(sidebarListElm, storageName);
        autoUpdateDateInputDefault();
    }   
    else {
        resetForm();
...
function fetchDataFromLocalStorage(targetOutputMain, nameStorage, targetOutputSidebar){
    if(!localStorage.getItem(nameStorage)) return;
        ...
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)(targetOutputSidebar, nameStorage);
    }
        ...
        allCard: 
            ()=>{
                ...
                for (let list of localSave) {
                        layerTarget.append((0,_toDoList__WEBPACK_IMPORTED_MODULE_1__.toDoListCard)(list, nameStorage, sidebarListElm).allCard());
                    }
                },
        titleCard:
            ()=>{
                //console.log(getFromLocalStorage(nameStorage));   
                for (let list of localSave) {
                        layerTarget.append((0,_toDoList__WEBPACK_IMPORTED_MODULE_1__.toDoListCard)(list, nameStorage, sidebarListElm).titleCard());
                    }
                }
    }
}
...
function todaysDate(){
    const date = new Date();
    let todayPattern = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, 'yyyy-MM-dd')
    return todayPattern;
}
...
function showToDoListSidebar(targetClass, nameStorage) {
    ...
    (0,___WEBPACK_IMPORTED_MODULE_0__.loopArray)(targetClass, nameStorage).titleCard();
}
...
function deleteListFunction(list, nameStorage, setSidebarElm){
    ...
    (0,___WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(nameStorage);
    (0,___WEBPACK_IMPORTED_MODULE_0__.showToDoList)('outputSection', nameStorage);
    (0,___WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)(setSidebarElm, nameStorage);
}
...
function checklistChange(check, list, nameStorage){
    if (check.checked === true) {
       // console.log(nameStorage);
        ...
        ___WEBPACK_IMPORTED_MODULE_0__.arrayToDo.changeChecklist(list);
        (0,___WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(nameStorage);
    }
