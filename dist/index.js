    ...
    return{ 
        allCard: 
            ()=>{   for (let list of arrayToDo.showArrayList().reverse()) {
                        ...
                        // setTimeout(()=>{
                        // layerTarget.childNodes.forEach((child)=>{child.classList.add('appear');});
                        // }, 300);
                    }
                },
        titleCard:
