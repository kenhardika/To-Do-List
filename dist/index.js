...
function fetchDataFromLocalStorage(targetOutputMain, nameStorage){
    if(!localStorage.getItem(nameStorage)) 
        ...
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)('myNoteList', 'myNotes');
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)('myProjectList', 'myProjects');
    }
}
        ...
        allCard: 
            ()=>{
                ...
                for (let list of localSave) {
                        layerTarget.append((0,_toDoList__WEBPACK_IMPORTED_MODULE_1__.toDoListCard)(list, nameStorage).allCard());
                    }
                },
        titleCard:
            ()=>{
                if (!localSave) return 
                    ...
                    for (let list of localSave) {
                            layerTarget.append((0,_toDoList__WEBPACK_IMPORTED_MODULE_1__.toDoListCard)(list, nameStorage).titleCard());
                        }}
                }
    }
}
...
function deleteListFunction(list, nameStorage){
    ...
    (0,___WEBPACK_IMPORTED_MODULE_0__.fetchDataFromLocalStorage)('outputSection', nameStorage);
