...
function actionNewToDoList(e){
    ...
    //add the variable of to do list to the aray 
     if (verifyInput(task) === true)  { 
        ...
        (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)('myNoteList', storageName);
...
function deleteListFunction(list, nameStorage){
    ...
    (0,___WEBPACK_IMPORTED_MODULE_0__.showToDoListSidebar)('myNoteList', nameStorage);
}
