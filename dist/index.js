...
/* harmony export */   "setStorageName": () => (/* binding */ setStorageName),
/* harmony export */   "storageName": () => (/* binding */ storageName)
/* harmony export */ });
/* harmony import */ var _accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accessLocalStorage */ "./src/accessLocalStorage.js");
...
function addToDoList(title, dueDate, priority, checklist, desc) {
  ...
  if (localStorage.getItem(storageName) === null) {
    ...
    arrayList = (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(storageName);
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clearDisplay);
...
/* harmony export */   "fetchDataFromLocalStorage": () => (/* binding */ fetchDataFromLocalStorage)
/* harmony export */ });
/* harmony import */ var _accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accessLocalStorage */ "./src/accessLocalStorage.js");
/* harmony import */ var _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ArrayToDoList */ "./src/ArrayToDoList.js");
/* harmony import */ var _clearDisplay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./clearDisplay */ "./src/clearDisplay.js");
...
function displayToDoList(targetClass, nameStorage) {
  ...
  let localSave = (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(nameStorage);

  return {
    allCard:
              () => {
                localSave = (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.getFromLocalStorage)(nameStorage);
...
function showToDoList(targetClass, nameStorage) {
  const layerTarget = document.querySelector(`.${targetClass}`);
  (0,_clearDisplay__WEBPACK_IMPORTED_MODULE_2__["default"])(layerTarget);
...
function checklistChange(check, list, nameStorage) {
  ...
  if (check.checked === true) {
    ...
    _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo.changeChecklist(list);
    console.log(nameStorage);
    (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(nameStorage, _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo);
...
function deleteListFunction(list, nameStorage) {
  _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo.removeFromArrayList(list.title);
  (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(nameStorage, _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo);
  fetchDataFromLocalStorage('outputSection', nameStorage);
}
...
/* harmony import */ var _accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accessLocalStorage */ "./src/accessLocalStorage.js");
/* harmony import */ var _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ArrayToDoList */ "./src/ArrayToDoList.js");
/* harmony import */ var _displayToDoList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./displayToDoList */ "./src/displayToDoList.js");
...
const getInput = () => ({
  ...
  dueDate: () => {
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(document.getElementById('inputDate').value), 'dd MM yy');
...
function isTitleOk(data) {
  if (_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo.findArrayList(data.title)) return false;
  return true;
}

function verifyInput(data) {
  // check the array if there is any data.
  if (!_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo.showArrayList()) return true;
...
function todaysDate() {
  const date = new Date();
  const todayPattern = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(date, 'yyyy-MM-dd');
  return todayPattern;
}
...
function myNotesPage() {
  ...
  myNotesBtn.onclick = () => {
    (0,_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.setStorageName)('myNotes');
    (0,_displayToDoList__WEBPACK_IMPORTED_MODULE_2__.fetchDataFromLocalStorage)('outputSection', _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.storageName);
...
function myProjectsPage() {
  ...
  myProjectsBtn.onclick = () => {
    (0,_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.setStorageName)('myProjects');
    (0,_displayToDoList__WEBPACK_IMPORTED_MODULE_2__.fetchDataFromLocalStorage)('outputSection', _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.storageName);
...
function actionNewToDoList(e) {
  ...
  const task = (0,_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.addToDoList)(
    inputToDo.title(),
    inputToDo.dueDate(),
    inputToDo.priority(),
    false,
  ...
  if (verifyInput(task) === true) {
    _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo.addToArrayList(task);
    (0,_accessLocalStorage__WEBPACK_IMPORTED_MODULE_0__.addToLocalStorage)(_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.storageName, _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.arrayToDo);
    (0,_displayToDoList__WEBPACK_IMPORTED_MODULE_2__.fetchDataFromLocalStorage)('outputSection', _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.storageName);
    resetForm();
...
function onLoadStart(setStrgName) {
  openFormBtn();
  (0,_ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.setStorageName)(setStrgName);
  submitInputForm();
  autoUpdateDateInputDefault();
  (0,_displayToDoList__WEBPACK_IMPORTED_MODULE_2__.fetchDataFromLocalStorage)('outputSection', _ArrayToDoList__WEBPACK_IMPORTED_MODULE_1__.storageName);
  myNotesPage();
