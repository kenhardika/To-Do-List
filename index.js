...
const getInput = () => {
    ...
    return {
        ...
        dueDate: ()=>{ 
            const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(document.getElementById('inputDate').value), 'dd-MM-yyyy');
