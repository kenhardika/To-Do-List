...
function todaysDate() {
  const date = new Date();
  const todayPattern = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(date, 'yyyy-MM-dd');
  return todayPattern;
}
